...
#define TIME_IGNORE_FALL_DAMAGE 1.0
...
#ifdef HL2MP
#define	HL2_WALK_SPEED 1800
#define	HL2_NORM_SPEED 1800
#define	HL2_SPRINT_SPEED 2500
#else
...
#define	FLASH_DRAIN_TIME	 0.0f //100 units / 90 secs
#define	FLASH_CHARGE_TIME	 50.0f	// 100 units / 2 secs
#define PLAYER_MODEL "models/Humans/Group01/Male_07.mdl"
...
#ifdef HL2MP
CSuitPowerDevice SuitDeviceSprint(bits_SUIT_DEVICE_SPRINT, 0.0f);				// 100 units in 4 seconds
#else
CSuitPowerDevice SuitDeviceSprint(bits_SUIT_DEVICE_SPRINT, 0.0f);				// 100 units in 8 seconds
#endif

#ifdef HL2_EPISODIC
CSuitPowerDevice SuitDeviceFlashlight(bits_SUIT_DEVICE_FLASHLIGHT, 0.0f);	// 100 units in 90 second
#else
CSuitPowerDevice SuitDeviceFlashlight(bits_SUIT_DEVICE_FLASHLIGHT, 0.0f);	// 100 units in 45 second
#endif
CSuitPowerDevice SuitDeviceBreather(bits_SUIT_DEVICE_BREATHER, 0.0f);		// 100 units in 15 seconds (plus three padded seconds)
